...
public class OLAPTable extends AbstractQueryableTable implements TranslatableTable {
    ...
    private static final Logger logger = LoggerFactory.getLogger(OLAPTable.class);
    ...
    private List<ColumnDesc> listSourceColumns() {
        ...
        for (ColumnDesc upgrade : updateColumns) {
            ...
            if (index >= 0) {
                ...
                logger.warn("OLAP table:" + sourceTable.getIdentity() + " can not find column:" + upgrade + " in columns:" + tableColumns);
            }
        }
