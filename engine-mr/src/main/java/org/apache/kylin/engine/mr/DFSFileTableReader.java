...
public class DFSFileTableReader implements TableReader {
    ...
    private String autoDetectDelim(String line) {
        ...
        logger.info("Auto detect delim to be null,delim:"+delim+",line:"+line+",expectedColumnNumber:"+expectedColumnNumber+", will take THE-WHOLE-LINE as a single value, for " + filePath);
        return null;
    }
