...
import org.apache.kylin.gridtable.IStorageResponseGTScatter;
 ...
 */
public class StorageResponseGTScatter implements IStorageResponseGTScatter {
    ...
    public StorageResponseGTScatter(GTInfo info, Iterator<byte[]> blocks, ImmutableBitSet columns,long totalScannedCount, AtomicLong totalCount, int storagePushDownLimit) {
        this.info = info;
        this.blocks = blocks;
