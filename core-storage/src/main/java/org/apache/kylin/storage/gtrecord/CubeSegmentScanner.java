...
//        logger.debug("Init CubeSegmentScanner for segment "+cubeSeg.getName());
        ...
        if(scanRangePlanner.isFilterSegment()){
            scanRequest = null;
        }else{
            scanRequest = scanRangePlanner.planScanRequest();
        }
        scanner = new ScannerWorker(cubeSeg, cuboid, scanRequest, gtStorage);
//        logger.debug("Init CubeSegmentScanner Done "+cubeSeg.getName());
    }
