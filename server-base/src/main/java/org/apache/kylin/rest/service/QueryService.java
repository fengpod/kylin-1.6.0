...
public class QueryService extends BasicService {
    ...
    public void logQuery(final SQLRequest request, final SQLResponse response) {
        ...
        stringBuilder.append("Request Id: ").append(request.getRequestId()).append(newLine);
        ...
        stringBuilder.append("Query end time: ").append(formatDate()).append(newLine);
        ...
        stringBuilder.append("Query Server: ").append(HOST_NAME).append(newLine);
        stringBuilder.append("==========================[QUERY]===============================").append(newLine);
    ...
    public SQLResponse doQueryWithCache(SQLRequest sqlRequest) {
        ...
        try (SetThreadName ignored = new SetThreadName("Query %s", queryId)) {
            ...
            logger.info("Using project: " + project+" The original query:  " + sql);
            ...
            if (sql.length() > 10 * 10000) {
                logger.debug("SQL is too long, directly return");
                throw new InternalErrorException("SQL too long.");
            }
            ...
            try {
                if (null == sqlResponse) {
                    ...
                    logger.debug("Stats of SQL response: isException: "+String.valueOf(sqlResponse.getIsException())+", duration: "+String.valueOf(sqlResponse.getDuration())+", total scan count "+ sqlResponse.getTotalScanCount());
...
//                checkQueryAuth(sqlResponse);
                ...
                if (OLAPContext.getThreadLocalContexts() != null) { // contexts can be null in case of 'explain plan for'
                    ...
                    sqlResponse.setTotalScanCount(totalScanCount);
                }
