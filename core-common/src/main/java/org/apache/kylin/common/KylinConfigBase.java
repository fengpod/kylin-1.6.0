...
abstract public class KylinConfigBase implements Serializable {
    ...
    public String getRedistributeColumn(){
        return getOptional("kylin.cube.redistribute.column");
    }
    ...
    public int getMaxConcurrentBuildDictJobsLimit(){
        return Integer.parseInt(getOptional("kylin.job.dict.concurrent.max.limit", "5"));
    }

    public int getJobBatchSize() {
        return Integer.parseInt(getOptional("kylin.job.batch.size", "1"));
    }
    ...
    public long getQueryDurationCacheThreshold() {
        return Long.parseLong(this.getOptional("kylin.query.cache.threshold.duration", String.valueOf(5000)));
    }
    ...
    public String getMailPort() {
        return getOptional("mail.port", "25");
    }
    ...
    // PREFIX
    // ============================================================================
    public String getKylinHtableNamePrefix() {
        return getOptional("kylin.hbase.table.prefix", "KYLIN_");
    }
    ...
    public String getKylinModelPartitionSameCol(){
        return getOptional("kylin.cube.partition.same", null);
    }
    
    public int getCubeStorageScanRowNumThreshold() {
        return Integer.parseInt(this.getOptional("kylin.cube.scan.num.threshold", "0"));
    }
    
    public int getColumnFamilyMeasureCount(){
        return Integer.parseInt(this.getOptional("kylin.cube.columnfamily.measure.count","-1"));
    }
// ============================================================================
    // SCAN DATE FILTER: YEAR,QUARTER,MONTH,SUNDAY
    // ============================================================================
    public boolean isScanDateFilterEnable() {
        return Boolean.parseBoolean(this.getOptional("kylin.cube.scan.datefilter.enable", "false"));
    }

    public String getDateFilterYearCol(){
        return getOptional("kylin.cube.scan.datefilter.year", "dim.dim_public_date_info.year");
    }

    public String getDateFilterQuarterCol(){
        return getOptional("kylin.cube.scan.datefilter.quarter", "dim.dim_public_date_info.quarter");
    }

    public String getDateFilterMonthCol(){
        return getOptional("kylin.cube.scan.datefilter.month", "dim.dim_public_date_info.month");
    }

    public String getDateFilterSundayCol(){
        return getOptional("kylin.cube.scan.datefilter.sunday", "dim.dim_public_date_info.sun_dt");
    }
    
    public Map<String,String> getKylinJobHfileMemConf(){
        return getPropertiesByPrefix("kylin.job.hfile.");
    }
}
