...
public class IRealizationConstants {
    ...
    public final static String SharedHbaseStorageLocationPrefix = KylinConfig.getInstanceFromEnv().getKylinHtableNamePrefix();
    public final static String CubeHbaseStorageLocationPrefix = KylinConfig.getInstanceFromEnv().getKylinHtableNamePrefix();;
